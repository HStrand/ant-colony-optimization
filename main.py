...
if __name__ == '__main__':
	...
	parser.add_argument("-er", type=float, help="Evaporation rate, how quickly the pheromones evaporate.")
	parser.add_argument("-q", type=int, help="Training parameter Q, amount of pheromones shared by ants.")
	parser.add_argument("-pr", type=int, help="Pheromone deposit amount to all edges in pheromone update.")
